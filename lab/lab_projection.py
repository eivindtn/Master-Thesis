...
axis_p1 = leg_center+stub_axis*1000 # define two points along the stub axis 
axis_p2 = leg_center-stub_axis*1000
...
stub  = v.shapes.Cylinder(pos=intersect_c[0], r=0.15*1000, height=2*1000, axis=stub_axis, c='teal3', alpha=1, cap=False, res=1000)
stub_mesh = stub.triangulate().alpha(0.2)
stub_config = stub_mesh.clone()
for i in range(len(axes)):
    stub_config.rotate(rotation[i],axis=axes[i],point=intersect_c[0])
